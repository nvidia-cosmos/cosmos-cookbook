...
- [Get started with Transfer2.5 and Predict2.5 on Brev](getting_started/transfer_and_predict_on_brev.md) - Deploy and run Cosmos models on NVIDIA Brev cloud platform
