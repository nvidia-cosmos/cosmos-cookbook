...
cosmos_compute: "1x A100 80GB (inference only)"
cosmos_output: "per-video reasoning assessments with correct/incorrect classification and comparative benchmark scores against Qwen3-VL-8B-Instruct"
