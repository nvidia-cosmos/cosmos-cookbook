...
|-----------|--------------|--------------|----------|----------|
| [Cosmos Transfer 1](https://github.com/nvidia-cosmos/cosmos-transfer1) | Inference | Sim to Real data augmentation | domain:industrial, technique:data-augmentation | 10-09-2025 |
