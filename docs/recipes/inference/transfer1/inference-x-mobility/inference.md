...
|-----------|--------------|--------------|----------|----------|
| [Cosmos Transfer 1](https://github.com/nvidia-cosmos/cosmos-transfer1) | Inference | Sim to Real data augmentation | domain:autonomous-vehicles, technique:data-augmentation | 10-27-2025 |
