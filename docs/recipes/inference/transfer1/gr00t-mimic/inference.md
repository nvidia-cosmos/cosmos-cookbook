...
|-----------|--------------|--------------|----------|
| [Cosmos Transfer 1](https://github.com/nvidia-cosmos/cosmos-transfer1) | Inference | Synthetic manipulation motion generation for humanoid robots | domain:robotics, technique:style-transfer |
