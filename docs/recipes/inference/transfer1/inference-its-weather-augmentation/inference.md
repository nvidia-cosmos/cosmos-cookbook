...
|-----------|--------------|--------------|----------|----------|
| [Cosmos Transfer 1](https://github.com/nvidia-cosmos/cosmos-transfer1) | Inference | Data augmentation | domain:autonomous-vehicles, technique:data-augmentation | 10-09-2025 |
