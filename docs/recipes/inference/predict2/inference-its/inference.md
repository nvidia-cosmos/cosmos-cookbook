...
|-----------|--------------|--------------|----------|----------|
| [Cosmos Predict 2](https://github.com/nvidia-cosmos/cosmos-predict2) | Inference | Synthetic Data Generation | domain:autonomous-vehicles, technique:prediction | 11-18-2025 |
