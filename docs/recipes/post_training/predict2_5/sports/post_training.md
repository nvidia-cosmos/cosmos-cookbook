...
|-----------|--------------|--------------|----------|----------|
| [Cosmos Predict 2.5](https://github.com/nvidia-cosmos/cosmos-predict2.5) | Post-training | Sports Video Generation | domain:smart-city, technique:post-training | 12-01-2025 |
