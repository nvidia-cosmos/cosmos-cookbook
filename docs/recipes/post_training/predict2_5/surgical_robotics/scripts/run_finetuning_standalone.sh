...
# For Docker: build the image from the Cosmos-H-Surgical-Simulator repo first (see §1.1–1.3),
...
# Docker image built from Cosmos-H-Surgical-Simulator (see §1.3). If unset, run on host using CODE_PATH.
