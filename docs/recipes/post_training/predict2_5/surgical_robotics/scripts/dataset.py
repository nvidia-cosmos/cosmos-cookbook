...
class WrappedLeRobotSingleDataset(LeRobotSingleDataset):
    ...
    def __getitem__(self, index: int) -> dict:
        ...
        try:
            ...
            print(f"WrappedLeRobotSingleDataset: {original_outputs['action'].shape}, {original_outputs['video'].shape}, {frames.shape}")
...
class LeRobotDataset(torch.utils.data.Dataset):
    ...
    def __getitem__(self, data_id):
        ...
        video_final = torch.from_numpy(video_frames).permute(3, 0, 1, 2)
        print(f"LeRobotDataset: {delta_actions.shape}, {actions.shape} , {video_frames.shape}, {video_final.shape}, {video.shape}")
