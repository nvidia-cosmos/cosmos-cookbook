...
|-----------|--------------|--------------|----------|----------|
| [Cosmos Predict 2](https://github.com/nvidia-cosmos/cosmos-predict2) | Post-training | Synthetic trajectory data generation for humanoid robots | domain:robotics, technique:post-training | 10-09-2025 |
