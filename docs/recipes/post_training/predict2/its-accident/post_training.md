...
|-----------|--------------|--------------|----------|
| [Cosmos Predict 2](https://github.com/nvidia-cosmos/cosmos-predict2) | Post-training | Traffic anomaly generation with improved realism and prompt alignment | domain:autonomous-vehicles |
