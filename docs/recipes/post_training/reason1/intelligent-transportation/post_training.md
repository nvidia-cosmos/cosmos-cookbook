...
|-----------|--------------|--------------|----------|----------|
| [Cosmos Reason 1](https://github.com/nvidia-cosmos/cosmos-reason1) | Post-training | Intelligent transportation scene understanding | domain:autonomous-vehicles, technique:post-training | 10-09-2025 |
