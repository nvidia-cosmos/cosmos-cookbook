...
|-----------|--------------|--------------|----------|----------|
| [Cosmos Reason 1](https://github.com/nvidia-cosmos/cosmos-reason1) | Post-training | Physical plausibility prediction | domain:industrial, technique:post-training | 10-09-2025 |
