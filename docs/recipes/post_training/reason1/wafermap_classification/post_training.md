...
|-----------|--------------|--------------|----------|----------|
| [Cosmos Reason 1](https://github.com/nvidia-cosmos/cosmos-reason1) | Post-training | Wafer Map Anomaly Classification | domain:industrial, technique:post-training | 12-12-2025 |
