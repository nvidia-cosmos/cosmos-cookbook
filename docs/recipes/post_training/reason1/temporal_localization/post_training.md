...
|-----------|--------------|--------------|----------|
| [Cosmos Reason 1](https://github.com/nvidia-cosmos/cosmos-reason1) | Post-training | Temporal localization for MimicGen data generation | domain:humanoid-robotics |
