...
> Jibin Varghese, Amol Fasale, & Jingyi Jin (2025). Core Curation with Cosmos-Curator. In *NVIDIA Cosmos Cookbook*. Retrieved from https://nvidia-cosmos.github.io/cosmos-cookbook/core_concepts/data_curation/core_curation.html
