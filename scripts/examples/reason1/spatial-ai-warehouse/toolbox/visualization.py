# Adapted from https://github.com/microsoft/SoM/blob/main/task_adapter/utils/visualizer.py
# Original code Copyright (c) Facebook, Inc. and its affiliates.
import colorsys
import logging
import math
import numpy as np
...
class Visualizer:
        ...
        *,
        ...
        if text is not None and has_valid_segment:
            if text_color is None:
                text_color = color
            self._draw_number_in_mask(binary_mask, text, text_color, label_mode, text_bg_color)
        return self.output
    ...
    def _draw_number_in_mask(self, binary_mask, text, color, label_mode='1', text_bg_color=None):
        """
